...
namespace ServerAPI2Cline.Controllers
{
    ...
    {
        private readonly ServerAPI2ClineContext _context;

        public CategoriesController(ServerAPI2ClineContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
           ...
           List< Category> reservationList = new List<Category>();
            using (var httpClient = new HttpClient())
            {
                ...
                using (var response = await httpClient.GetAsync("https://localhost:44328/api/Categories"))
                {
