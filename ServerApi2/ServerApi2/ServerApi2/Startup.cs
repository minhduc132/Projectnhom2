...
namespace ServerAPI
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ServerApi2Context>(options =>
                    options.UseSqlServer(Configuration.GetConnectionString("ServerApi2Context")));

            services.AddIdentity<IdentityUser, IdentityRole>()
                       .AddEntityFrameworkStores<ServerApi2Context>()
